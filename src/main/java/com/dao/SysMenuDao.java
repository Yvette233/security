...
@Repository
public class SysMenuDao extends BasicDao<SysMenu> {
    private static final Log log = LogFactory.getLog(SysMenuDao.class);


    public List<SysMenu> getMenuList(String id, String parentId, Page page) {
        ...
        CriteriaQuery<SysMenu> criteriaQuery = this.getCriteriaQuery(propertyList, page);
